[[{'align_bam': '/bcbio-nextgen/tests/test_automated_output/align/Test1/hg19/Test1_star/Test1.bam',
   'analysis': 'RNA-seq',
   ...
   'disambiguate': {'base': True, 'genome_build': 'hg19'},
   ...
   'provenance': {'data': '/bcbio-nextgen/tests/test_automated_output/provenance/data_versions.csv',
                  'db': None,
                  'entity': '952411ba-c2de-11e6-a323-0242ac110002.prepare_sample.0.trim_sample.0.process_alignment.0',
   ...
   'upload': {'dir': '/bcbio-nextgen/tests/test_automated_output/upload',
              'run_id': ''},
   'work_bam': '/bcbio-nextgen/tests/test_automated_output/align/Test1/hg19/Test1_star/Test1.bam'}],
 [{'align_bam': '/bcbio-nextgen/tests/test_automated_output/align/Test1/mm9/Test1_star/Test1.bam',
   'analysis': 'RNA-seq',
   'config': {'algorithm': {'adapters': ['truseq', 'polya'],
                            'aligner': 'star',
                            'archive': [],
   ...
   'dirs': {'config': '/bcbio-nextgen/tests/test_automated_output',
            ...
            'galaxy': '/bcbio-nextgen/tests/data/automated',
            'work': '/bcbio-nextgen/tests/test_automated_output'},
   'disambiguate': {'genome_build': 'mm9'},
   'files': ['/bcbio-nextgen/tests/test_automated_output/trimmed/1_1_Test1.trimmed.fq.gz',
             '/bcbio-nextgen/tests/test_automated_output/trimmed/1_2_Test1.trimmed.fq.gz'],
   'genome_build': 'mm9',
   'genome_resources': {'aliases': {'ensembl': 'mouse',
                                    'snpeff': 'NCBIM37'},
                        'rnaseq': {'gene_bed': '/bcbio-nextgen/tests/data/genomes/mm9/rnaseq/ref-transcripts.bed',
                                   'transcripts': '/bcbio-nextgen/tests/data/genomes/mm9/rnaseq/ref-transcripts.gtf',
                                   'transcripts_mask': '/bcbio-nextgen/tests/data/genomes/mm9/rnaseq/ref-transcripts-mask.gtf'},
                        'version': 1},
   'hla': {'fastq': None},
   'lane': '1',
   'metadata': {'batch': None, 'phenotype': ''},
   ...
   'provenance': {'data': '/bcbio-nextgen/tests/test_automated_output/provenance/data_versions.csv',
                  'db': None,
                  'entity': '952411ba-c2de-11e6-a323-0242ac110002.prepare_sample.0.trim_sample.0.process_alignment.1',
                  'programs': '/bcbio-nextgen/tests/test_automated_output/provenance/programs.txt'},
   'reference': {'fasta': {'base': '/bcbio-nextgen/tests/data/genomes/mm9/seq/mm9.fa'},
                 'genome_context': [],
                 'rtg': '/bcbio-nextgen/tests/data/genomes/mm9/rtg/mm9.sdf',
                 'star': {'indexes': ['/bcbio-nextgen/tests/data/genomes/mm9/star/chrLength.txt',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/SA',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/Genome',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/SAindex',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/chrStart.txt',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/chrName.txt',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/chrNameLength.txt',
                                      '/bcbio-nextgen/tests/data/genomes/mm9/star/genomeParameters.txt']}},
   'resources': {},
   'rgnames': {'lane': 'Test1',
               'lb': None,
               'pl': 'illumina',
               ...
               'rg': 'Test1',
               'sample': 'Test1'},
   'sam_ref': '/bcbio-nextgen/tests/data/genomes/mm9/seq/mm9.fa',
   'transcriptome_bam': None,
   'upload': {'dir': '/bcbio-nextgen/tests/test_automated_output/upload',
              'run_id': ''},
   'work_bam': '/bcbio-nextgen/tests/test_automated_output/align/Test1/mm9/Test1_star/Test1.bam'}]]
