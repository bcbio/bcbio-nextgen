...
curl -O http://raw.github.com/chapmanb/bcbio-nextgen/master/scripts/vm/Vagrantfile
curl -O http://raw.github.com/chapmanb/bcbio-nextgen/master/scripts/vm/osx/bootstrap.sh
vagrant up
